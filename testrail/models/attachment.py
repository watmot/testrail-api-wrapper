...
class AttachmentModel(CreatedByMixin, CreatedOnMixin, EstimateMixin, EstimateForecastMixin, IdMixin, MilestoneIdMixin,
                      ProjectIdMixin, PriorityIdMixin, RefsMixin, SectionIdMixin, SuiteIdMixin, TemplateIdMixin,
                      TitleMixin, TypeIdMixin, UpdatedByMixin, UpdatedOnMixin, DeleteMixin, UpdateMixin, AddMixin,
                      GetMixin, PostModel):
    ENDPOINTS = {
